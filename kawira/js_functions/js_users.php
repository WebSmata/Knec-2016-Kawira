<?php
	function js_signin() {
		...
		$loginkey = md5($_POST['password']);
			...
			$_SESSION['kawira_user'] = js_let_me_user($loginname, $loginkey);
			$_SESSION['kawira_account'] = js_logged_account($loginname);
	...
	function js_is_logged(){
		$myloginid = isset( $_SESSION['kawira_user'] ) ? $_SESSION['kawira_user'] : "";
...
function logout() {
  unset( $_SESSION['kawira_user'] );
  unset( $_SESSION['kawira_account'] );
  header( "Location: index.php" );
}
