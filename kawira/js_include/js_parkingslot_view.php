<?php 
	...
	$catid = $results['type'];
	$js_db_query = "SELECT * FROM js_parkingslot WHERE catid = '$catid'";
		...
		<br>
          ...
          <br><hr><br>
			<div class="main_content">
				<form role="form" method="post" name="PostParking Slot" action="index.php?action=viewcat&&js_catid=<?php echo $catid ?>" enctype="multipart/form-data" >
